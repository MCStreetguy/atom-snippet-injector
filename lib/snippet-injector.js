    ...
    if(filenames.length > 0) {
      ...
      const searchPrompt = Util.promptSearch({
        ...
        if(Util.isset(element,'string')) {
          var snippet = storage.getByProperty('uid',element);
          ...
          storage.replace(snippet,storage.getIndexByProperty('uid',snippet.getUID()));
    ...
    if(filenames.length > 0) {
      ...
      const searchPrompt = Util.promptSearch({
        ...
        if(Util.isset(element,'string')) {
          ...
          if(storage.replace(snippet,storage.getIndexByProperty('uid',snippet.getUID()))) {
