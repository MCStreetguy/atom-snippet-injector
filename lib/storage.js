...
export default class StorageInterface {
  ...
  _atom_sync() {
    ...
    _this.snippets.forEach(function(e) {
      ...
      var prefix = e.getTitle().toLowerCase().split(/[^\w\s]/).join('').split(/\s\s+/).join(' ');
  ...
  _write_atom_sync() {
    var toFile = '# This file was autogenerated by the snippet-injector package\n'
                ...
                + CSON.stringify(this._snippets_cson_data).toString();
    fs.writeFileSync(this._snippets_cson,toFile);
  }
